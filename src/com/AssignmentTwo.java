...
public class AssignmentTwo {
    ...
    private String FILE_PATH = "E:/GitHub/JAVA/chengluyu-A2/test.txt";
    ...
    private List<Visitor> createVisitor(){
        Visitor one = new Visitor("one","18","man","20",new Date());
        Visitor tow = new Visitor("tow","20","man","20",new Date());
        Visitor three = new Visitor("three","18","man","20",new Date());
        Visitor four = new Visitor("four","18","man","20",new Date());
        Visitor five = new Visitor("five","19","man","20",new Date());
